...
export default function HeroText() {
  return (
    <>
      <h1 className="mb-7.5 relative font-extrabold text-[69px] leading-[110%] text-white">
        ...
        />
        <Image width="88" height="55" src="/hero/vector1.svg" className="absolute right-12 top-10" alt="" />
      </h1>
