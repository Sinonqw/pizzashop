...
export function PriceCounter({ baseCost, selectedSize }: PriceCounterProps) {
  ...
  return (
    <div className="flex items-center gap-12 w-full">
      ...
      >
        {currentPrice}
        <sup className="text-lg font-light">$</sup>
      </div>

      <div className="flex items-center gap-2">
        <button className={minusButtonClasses} onClick={handleDecrease}>
          {minusButtonBorder}
          <span className={`relative z-10 ${buttonTextStyles} text-[#a3a3a3]`}>
            -
          </span>
        </button>
        ...
        <button className={plusButtonClasses} onClick={handleIncrease}>
